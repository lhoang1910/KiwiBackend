...
import com.kiwi.exception.BadRequestException;
import com.kiwi.exception.InternalServerException;
...
public class ImageController {
	...
	public ResponseEntity<?> deleteImage(Long id) {
		...
		return ResponseEntity.ok(new MessageResponse("Image is delete"));
	}
}
